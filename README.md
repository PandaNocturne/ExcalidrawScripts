...
- Author：熊猫别熬夜
- Description：统一调整选中文本的字号，可按最大字号、最小字号或自定义字号批量缩放。

### AddBackgroundcolor

```excalidraw-script-install
https://raw.githubusercontent.com/PandaNocturne/ExcalidrawScripts/master/PandaScripts/AddBackgroundcolor.md
```

- Author：熊猫别熬夜
- Description：为选中元素自动添加一个高亮背景矩形，并与原元素编组，适合做重点标注。
...
- Author：熊猫别熬夜
- Description：聚合 Excalidraw 画板中的图片 OCR、文本、Frame 和嵌入文档内容，生成可检索的全局搜索信息。
...
- Author：熊猫别熬夜
- PKMerDoc：[PKMer\_自定义 Excalidraw 脚本 - 制作 Excalidraw 悬浮大纲以及一键生成线型笔记](https://pkmer.cn/show/20231029232811)
