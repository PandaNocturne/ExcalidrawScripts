...
![](Images/19567489151ba3ebb307e48831a6d4e5.png)
...
- Description：提供一个 Frame 边框切换的提示框。
	- ![](Images/5bb5f5ff3d0904c44b7924d00c505cc5.gif)
...
- Description：快速插入或删除时间戳笔记
	- ![](Images/8e7920e0dc714fd56f08ba0ea1cea90c.png)
	- ![](Images/2f92a0a652ef1018a396929f0d91f88b.gif)
	- 选择或框选笔记后，再次运行脚本就可以删除本地笔记和画板元素了
		- ![](Images/3c3d9c919d425e96653c847ec97fa987.gif)
...
- Description：插入可以二次编辑的 Mermaid 矢量图
	- ![](Images/a04af6892cddf799192fe0a7fd2a05aa.gif)
	- `Ctrl + 鼠标左键单击` 可以弹出源码：
		- ![](Images/e28c97794733351ce4ebf6701e9e2ef3.gif)
...
- Description：编号模式，双击添加或编辑编号
	- ![](Images/c95d93ed00d130d9ed23e16fd3f1a2f2.gif)
		- ✅已启动编号模式，双击添加 num
		- ⏩双击 num 可以重新编辑编号
		- ⏹再次运行脚本即可退出编号模式
...
- Description：设定默认或其他软件打开图片
	...
	- ![](Images/fd9854c10322d74d836c59f46c276270.png)
	- ![](Images/a6561992c1e8b9a56e224727b7c70da3.png)
...
- Description：使用 Text Extractor 插件或者本地 Paddleocr 模型批量识别画板中的图片到 Yaml 区，可编辑修改。
	- ![](Images/266c667788596fe6fa0bb96863a0cd0d.gif)
	- ![](Images/42801e05673fb58dabfb4ce39cc7e7d5.png)
- ChangeLog：
	- 2023-12-29：
...
- Description：用于调整多个图片 (image)、矩形框 (rectangle)、Frame 边框的大小，以选中的元素的最大宽度 (高度) 或者最小宽度 (高度) 进行统一缩放，分别有 `等宽缩放`、`等高缩放`、`完全相等` 这 3 个选项。
	- ![](Images/99718c40ffc9fe8f6f8426c329a8ccb1.gif)
...
- Description：将 Excalidraw 画板中引用的图片直接上传到 PicGo 的 Server 后并删除本地文件 (可不删除)
	- ![](Images/20b7a760ebb366fa03d213836a0ee229.gif)
	- ![](Images/2beb3d767ade9abc7a7d116c16074288.png)
...
- Description：逐步显示 Excalidraw 画板的元素
	- ![](Images/a1413f21d4c85fc051bbc3ee411511a4.png)
	- ![](Images/2648857a00a62ee2e3ed5c87d713c910.gif)
	- ![](Images/6688880a72a0656bad9d155e61147701.gif)
...
- ChangeLog：
	- 2024-03-02：
		- 添加缩略图是否添加连接选项，参数修改为中文注释
			- ![](Images/2c649c1a58fca2a8e87740901ffe8366.png)
...
- Description：实现 Zotero 标注文本或者图片通过拖拽或者复制粘贴的形式添加到 Excalidraw 画板中
	- ![](Images/22c7ae053c8f9d20a087f0ed79fc8f0f.png)
- ChangeLog：
...
> 	- ![](Images/d261e95005989168f2ac76e7add0b8ee.png)
...
- Description：联动 Bookxnote 与 Excalidraw
	- ![](Images/ab40a64767bc3a404a5f83530bc8158e.gif)
...
> 	- ![](Images/098517dc1fdd968dbb6cb8c4d78f266c.png)
...
> 	- ![](Images/a70b69414946a92c4fed3a08138f750f.png)
